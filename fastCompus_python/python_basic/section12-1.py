...
# DB생성 & Autocommit
# 본인 DB 파일 경로
conn = sqlite3.connect('F:/VSCode_EH/fastCompus_python/python_basic/resource/database.db', isolation_level=None)
...
# 데이터 삽입
# c.execute("INSERT INTO users VALUES(1, 'LYU', 'lyu1025@nate.com','010-6755-7969','lyu.com',?)", (nowDatetime,))
# c.execute("INSERT INTO users(id, username, email, phone, website, regdate) VALUES (?,?,?,?,?,?)",
# (2, 'Park', 'Park@naver.com', '010-1111-1111', 'Park.com', nowDatetime))

# Many 삽입(튜플, 리스트) : 많은 데이터를 한번에
# userList = (
